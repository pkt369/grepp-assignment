...
- 로깅의 경우 파일로 저장하도록 구현하였고, 나중에 **Logstash + Kakfa + Elastic Search 또는 Logstash + Clickhouse + Garafana** 적용을 고려할 수 있습니다.
- 검색은 Postgresql 의 FTS 와 config: simple 을 사용하여 진행하였습니다.
    - 한글 검색 품질 향상을 위해 pg_bigm 적용을 고려할 수 있습니다.
